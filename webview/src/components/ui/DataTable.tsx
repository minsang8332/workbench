...
export default defineComponent({
    ...
    setup(props) {
        ...
        const paginatedRows = computed(() => {
            ...
            return _.slice(filteredData.value, start, start + rowsPerPage.value)
        })
        ...
        return () => (
            <div class="data-table flex flex-col h-full w-full">
                <div class="data-table__header flex justify-between box-border shrink-0">
                    <input type="text" v-model={searchQuery.value} placeholder="Search..." />
                    <select v-model={rowsPerPage.value} class="flex items-center">
                ...
                <div class="data-table__actions flex justify-center items-center gap-4">
                    <button class="btn-pagination" onClick={onPrev} disabled={curPage.value === 1}>
                        이전
                    </button>
                    <span>
